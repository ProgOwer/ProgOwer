...
git remote add neonlit ssh://git@git.neonlit.fr:2222/progower/progower.git
git remote set-url --add --push origin ssh://git@git.neonlit.fr:2222/progower/progower.git
